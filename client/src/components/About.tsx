...
export function About() {
  ...
  const TeamModal = () => {
    const groupedMembers =
      teamMembers?.reduce(
        (groups: Record<string, Record<string, TeamMember[]>>, member) => {
                      ...
                      <div key={category}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          {members.map((member) => (
                            ...
                            >
                              <div
                                className={`w-10 h-10 ${getCategoryColor(category)} rounded-full flex items-center justify-center text-white font-bold mr-3`}
                              >
  ...
  const InnovationModal = () => (
    ...
    >
      <div className="space-y-4">
        <img
          src="/src/assets/images/move.png"
